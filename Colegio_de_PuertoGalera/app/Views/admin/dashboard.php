							...
							<div class="card-body">
								<div class="dash-widget-header">
									<div>
										...
										<h6 class="text-muted">Total Teachers</h6> </div>
							...
							<div class="card-body">
								<div class="dash-widget-header">
									<div>
										...
										<h6 class="text-muted">Total Events</h6> </div>
							...
							<div class="card-body">
								<div class="dash-widget-header">
									...
									<h3 class="card_widget_header"><?= $totalNews ?></h3>
										<h6 class="text-muted">Total News</h6> </div>
                        ...
                        <tbody>
                            <?php foreach ($teachers as $teacher): ?>
                                <tr>
                                    ...
                                    <td><img src="<?= base_url('uploads/' . $teacher['image']) ?>" alt="<?= $teacher['name'] ?>" class="teacher-image"></td>
